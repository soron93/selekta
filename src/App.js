...
class App extends Component {
  ...
  handleAddCrud = async (event) => {
    ...
    axios
      .post(`${API_URL}/api/create`, newCrud, { withCredentials: true })
      .then((response) => {
  ...
  handleDeleteCrud = (crudId) => {
    ...
    axios
      .delete(`${API_URL}/api/cruds/${crudId}`, { withCredentials: true })
      .then(() => {
  ...
  handleEditCrud = (event, crud) => {
    ...
    axios
      .patch(`${API_URL}/api/cruds/${crud._id}`, crud, {
        withCredentials: true,
      })
      .then(() => {
  ...
  handleSelekting = () => {
    ...
    axios
      .post(`${API_URL}/api/generate-playlist`, audio_features, {
        withCredentials: true,
      })
      .then((response) => {
        console.log(response.data);
        ...
        <Switch>
          <Route
            ...
            render={(routeProps) => {
              ...
              return (
                <Selekta
                  onSelekting={this.handleSelekting}
